...
>> = {
  'local-text': {
    ...
    message: '이 파일은 브라우저에서 직접 읽으며 원본 파일을 MISO로 전송하지 않습니다.',
    buttonLabel: '브라우저에서 텍스트 읽기',
  },
  'local-excel': {
    title: '브라우저에서 처리',
    ...
    transmission: 'never',
    transmissionLabel: '전송 안 함',
    message: '이 엑셀 파일은 브라우저에서 변환하며 원본 파일을 MISO로 전송하지 않습니다.',
    buttonLabel: '브라우저에서 엑셀 변환하기',
  },
  'local-docx': {
    title: '로컬 추출 우선',
    ...
    message: 'DOCX는 먼저 브라우저에서 추출합니다. 로컬 추출이 실패하면 원본 파일을 MISO로 전송해 다시 시도합니다. 원본 파일을 전송하면 안 된다면 TXT로 변환한 뒤 업로드하세요.',
    buttonLabel: 'DOCX 처리 시작 (실패 시 MISO 전송)',
  },
  miso: {
    title: 'MISO로 전송',
    ...
    message: '이 형식은 텍스트 추출을 위해 원본 파일을 MISO로 전송해 처리합니다.',
    buttonLabel: 'MISO로 전송해 텍스트 추출',
  },
  unsupported: {
    title: '지원하지 않는 형식',
